...
function comprarCarrito() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            doc.text(`Total: $${totalCalculado}`, 150, 20);
            ...
            // Add the details of each product to the document
            let y = 35;
            let x = 20;
            let count = 0;
            let page = 1;
            productosEnCarrito.forEach(producto => {
                ...
                doc.setFontType("normal");
                y += 7;
                doc.text(`Cantidad: ${producto.cantidad}`, x, y);
                y += 7;
                doc.text(`Subtotal: $${producto.precio * producto.cantidad}`, x, y);
                y += 10;
                count++;
            });
